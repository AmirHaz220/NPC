...
class RigUI(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if is_selected({'tweak_spine.003', 'spine_fk.002', 'tweak_spine.001', 'hips', 'spine_fk', 'head', 'torso', 'tweak_spine.002', 'chest', 'neck', 'tweak_spine', 'spine_fk.001'}):
            emit_rig_separator()
            if is_selected({'spine_fk'}):
                layout.prop(pose_bones['spine_fk'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'spine_fk.001'}):
                layout.prop(pose_bones['spine_fk.001'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'spine_fk.002'}):
                layout.prop(pose_bones['spine_fk.002'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            ...
            if is_selected({'tweak_spine.003', 'spine_fk.002', 'tweak_spine.001', 'hips', 'spine_fk', 'tweak_spine.002', 'torso', 'chest', 'tweak_spine', 'spine_fk.001'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_6qkyd0nhabc18416', text='Torso Parent', icon='DOWNARROW_HLT')
                props.bone = 'torso'
                ...
                props = group1.operator('pose.rigify_switch_parent_bake_6qkyd0nhabc18416', text='', icon='ACTION_TWEAK')
                props.bone = 'torso'
                props.prop_bone = 'torso'
                props.prop_id = 'torso_parent'
                props.parent_names = '["None", "Root"]'
        ...
        if is_selected({'breast.R'}):
            emit_rig_separator()
            layout.prop(pose_bones['breast.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)

        if is_selected({'shoulder.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['shoulder.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)

        if is_selected({'upper_arm_ik_target.L', 'forearm_tweak.L.001', 'hand_fk.L', 'upper_arm_ik.L', 'hand_ik.L', 'forearm_tweak.L', 'VIS_upper_arm_ik_pole.L', 'upper_arm_parent.L', 'upper_arm_fk.L', 'forearm_fk.L', 'upper_arm_tweak.L', 'hand_tweak.L', 'upper_arm_tweak.L.001'}):
            emit_rig_separator()
            if is_selected({'upper_arm_fk.L', 'hand_fk.L', 'forearm_fk.L', 'upper_arm_parent.L'}):
                layout.prop(pose_bones['upper_arm_parent.L'], '["FK_limb_follow"]', text='FK Limb Follow', slider=True)
            if is_selected({'upper_arm_fk.L'}):
                layout.prop(pose_bones['upper_arm_fk.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['upper_arm_parent.L'], '["IK_FK"]', text='IK-FK (hand.L)', slider=True)
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_6qkyd0nhabc18416', text='FK->IK (hand.L)', icon='SNAP_ON')
            ...
            props = group2.operator('pose.rigify_generic_snap_bake_6qkyd0nhabc18416', text='Action', icon='ACTION_TWEAK')
            props.output_bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            props.input_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
            props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
            props = group2.operator('pose.rigify_clear_keyframes_6qkyd0nhabc18416', text='Clear', icon='CANCEL')
            props.bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_6qkyd0nhabc18416', text='IK->FK (hand.L)', icon='SNAP_ON')
            ...
            props.extra_ctrls = '[]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_limb_ik2fk_bake_6qkyd0nhabc18416', text='Action', icon='ACTION_TWEAK')
            props.prop_bone = 'upper_arm_parent.L'
            props.fk_bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
            props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
            ...
            if is_selected({'upper_arm_ik_target.L', 'upper_arm_ik.L', 'hand_ik.L', 'upper_arm_parent.L'}):
                layout.prop(pose_bones['upper_arm_parent.L'], '["IK_Stretch"]', text='IK Stretch', slider=True)
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_limb_toggle_pole_6qkyd0nhabc18416', icon='FORCE_MAGNETIC')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
                props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
                props.extra_ctrls = '[]'
                group2.prop(pose_bones['upper_arm_parent.L'], '["pole_vector"]', text='')
                props = group1.operator('pose.rigify_limb_toggle_pole_bake_6qkyd0nhabc18416', text='', icon='ACTION_TWEAK')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
                props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
                props.extra_ctrls = '[]'
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_6qkyd0nhabc18416', text='IK Parent', icon='DOWNARROW_HLT')
                ...
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_6qkyd0nhabc18416', text='Pole Parent', icon='DOWNARROW_HLT')
        ...
        if is_selected({'f_index.02.L', 'f_index.03.L', 'f_index.01_master.L', 'f_index.01.L.001', 'f_index.01.L'}):
            emit_rig_separator()
            if is_selected({'f_index.01.L'}):
                layout.prop(pose_bones['f_index.01.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['f_index.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_middle.01.L.001', 'f_middle.03.L', 'f_middle.01_master.L', 'f_middle.01.L', 'f_middle.02.L'}):
            emit_rig_separator()
            if is_selected({'f_middle.01.L'}):
                layout.prop(pose_bones['f_middle.01.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_middle.03.L'}):
                layout.prop(pose_bones['f_middle.03.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['f_middle.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_pinky.01_master.L', 'f_pinky.01.L', 'f_pinky.03.L', 'f_pinky.02.L', 'f_pinky.01.L.001'}):
            emit_rig_separator()
            if is_selected({'f_pinky.01.L'}):
                layout.prop(pose_bones['f_pinky.01.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_pinky.02.L'}):
                layout.prop(pose_bones['f_pinky.02.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_pinky.03.L'}):
                layout.prop(pose_bones['f_pinky.03.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
        ...
        if is_selected({'f_ring.01_master.L', 'f_ring.03.L', 'f_ring.01.L', 'f_ring.01.L.001', 'f_ring.02.L'}):
            emit_rig_separator()
            if is_selected({'f_ring.01.L'}):
                layout.prop(pose_bones['f_ring.01.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_ring.02.L'}):
                layout.prop(pose_bones['f_ring.02.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_ring.03.L'}):
                layout.prop(pose_bones['f_ring.03.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['f_ring.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'thumb.02.L', 'thumb.01.L', 'thumb.03.L', 'thumb.01.L.001', 'thumb.01_master.L'}):
            emit_rig_separator()
            if is_selected({'thumb.01.L'}):
                layout.prop(pose_bones['thumb.01.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'thumb.02.L'}):
                layout.prop(pose_bones['thumb.02.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'thumb.03.L'}):
                layout.prop(pose_bones['thumb.03.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['thumb.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'shoulder.R'}):
            emit_rig_separator()
            layout.prop(pose_bones['shoulder.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)

        if is_selected({'forearm_tweak.R', 'upper_arm_tweak.R', 'hand_ik.R', 'upper_arm_ik.R', 'forearm_tweak.R.001', 'hand_fk.R', 'forearm_fk.R', 'upper_arm_parent.R', 'upper_arm_tweak.R.001', 'upper_arm_fk.R', 'hand_tweak.R', 'upper_arm_ik_target.R', 'VIS_upper_arm_ik_pole.R'}):
            emit_rig_separator()
            if is_selected({'hand_fk.R', 'upper_arm_fk.R', 'forearm_fk.R', 'upper_arm_parent.R'}):
                layout.prop(pose_bones['upper_arm_parent.R'], '["FK_limb_follow"]', text='FK Limb Follow', slider=True)
            if is_selected({'upper_arm_fk.R'}):
                layout.prop(pose_bones['upper_arm_fk.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'forearm_fk.R'}):
                layout.prop(pose_bones['forearm_fk.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'hand_fk.R'}):
                layout.prop(pose_bones['hand_fk.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['upper_arm_parent.R'], '["IK_FK"]', text='IK-FK (hand.R)', slider=True)
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_6qkyd0nhabc18416', text='FK->IK (hand.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_6qkyd0nhabc18416', text='IK->FK (hand.R)', icon='SNAP_ON')
        ...
        if is_selected({'f_index.01.R', 'f_index.01_master.R', 'f_index.03.R', 'f_index.01.R.001', 'f_index.02.R'}):
            emit_rig_separator()
            if is_selected({'f_index.01.R'}):
                layout.prop(pose_bones['f_index.01.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_index.02.R'}):
                layout.prop(pose_bones['f_index.02.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_index.03.R'}):
                layout.prop(pose_bones['f_index.03.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['f_index.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_middle.03.R', 'f_middle.01.R', 'f_middle.01.R.001', 'f_middle.02.R', 'f_middle.01_master.R'}):
            emit_rig_separator()
            if is_selected({'f_middle.01.R'}):
                layout.prop(pose_bones['f_middle.01.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_middle.02.R'}):
                layout.prop(pose_bones['f_middle.02.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_middle.03.R'}):
                layout.prop(pose_bones['f_middle.03.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['f_middle.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_pinky.01_master.R', 'f_pinky.01.R', 'f_pinky.02.R', 'f_pinky.01.R.001', 'f_pinky.03.R'}):
            emit_rig_separator()
            if is_selected({'f_pinky.01.R'}):
                layout.prop(pose_bones['f_pinky.01.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_pinky.02.R'}):
                layout.prop(pose_bones['f_pinky.02.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_pinky.03.R'}):
                layout.prop(pose_bones['f_pinky.03.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['f_pinky.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_ring.01.R', 'f_ring.01.R.001', 'f_ring.03.R', 'f_ring.02.R', 'f_ring.01_master.R'}):
            emit_rig_separator()
            if is_selected({'f_ring.01.R'}):
                layout.prop(pose_bones['f_ring.01.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_ring.02.R'}):
                layout.prop(pose_bones['f_ring.02.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'f_ring.03.R'}):
                layout.prop(pose_bones['f_ring.03.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['f_ring.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'thumb.01_master.R', 'thumb.02.R', 'thumb.03.R', 'thumb.01.R.001', 'thumb.01.R'}):
            emit_rig_separator()
            if is_selected({'thumb.01.R'}):
                layout.prop(pose_bones['thumb.01.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'thumb.02.R'}):
                layout.prop(pose_bones['thumb.02.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'thumb.03.R'}):
                layout.prop(pose_bones['thumb.03.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['thumb.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'head', 'neck'}):
            emit_rig_separator()
            if is_selected({'neck'}):
                layout.prop(pose_bones['neck'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'head'}):
                layout.prop(pose_bones['head'], '["mmd_bone"]', text='Mmd Bone', slider=False)

        if is_selected({'thigh_tweak.L', 'foot_heel_ik.L', 'foot_ik.L', 'shin_tweak.L', 'thigh_ik_target.L', 'shin_fk.L', 'toe.L', 'thigh_fk.L', 'VIS_thigh_ik_pole.L', 'foot_fk.L', 'thigh_ik.L', 'thigh_parent.L', 'foot_tweak.L', 'foot_spin_ik.L'}):
            emit_rig_separator()
            if is_selected({'shin_fk.L', 'toe.L', 'foot_fk.L', 'thigh_fk.L', 'thigh_parent.L'}):
                layout.prop(pose_bones['thigh_parent.L'], '["FK_limb_follow"]', text='FK Limb Follow', slider=True)
            if is_selected({'thigh_fk.L'}):
                layout.prop(pose_bones['thigh_fk.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'shin_fk.L'}):
                layout.prop(pose_bones['shin_fk.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'foot_fk.L'}):
                layout.prop(pose_bones['foot_fk.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'toe.L'}):
                layout.prop(pose_bones['toe.L'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['thigh_parent.L'], '["IK_FK"]', text='IK-FK (foot.L)', slider=True)
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_6qkyd0nhabc18416', text='FK->IK (foot.L)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_6qkyd0nhabc18416', text='IK->FK (foot.L)', icon='SNAP_ON')
            ...
            if is_selected({'foot_heel_ik.L', 'foot_ik.L', 'foot_spin_ik.L', 'thigh_ik.L', 'thigh_parent.L', 'thigh_ik_target.L'}):
        ...
        if is_selected({'VIS_thigh_ik_pole.R', 'toe.R', 'thigh_tweak.R', 'foot_fk.R', 'thigh_ik.R', 'foot_tweak.R', 'thigh_fk.R', 'thigh_parent.R', 'shin_tweak.R', 'thigh_ik_target.R', 'foot_spin_ik.R', 'shin_fk.R', 'foot_heel_ik.R', 'foot_ik.R'}):
            emit_rig_separator()
            if is_selected({'toe.R', 'foot_fk.R', 'thigh_fk.R', 'shin_fk.R', 'thigh_parent.R'}):
                layout.prop(pose_bones['thigh_parent.R'], '["FK_limb_follow"]', text='FK Limb Follow', slider=True)
            if is_selected({'thigh_fk.R'}):
                layout.prop(pose_bones['thigh_fk.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'shin_fk.R'}):
                layout.prop(pose_bones['shin_fk.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'foot_fk.R'}):
                layout.prop(pose_bones['foot_fk.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            if is_selected({'toe.R'}):
                layout.prop(pose_bones['toe.R'], '["mmd_bone"]', text='Mmd Bone', slider=False)
            layout.prop(pose_bones['thigh_parent.R'], '["IK_FK"]', text='IK-FK (foot.R)', slider=True)
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_6qkyd0nhabc18416', text='FK->IK (foot.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_6qkyd0nhabc18416', text='IK->FK (foot.R)', icon='SNAP_ON')
            ...
            if is_selected({'foot_spin_ik.R', 'foot_ik.R', 'thigh_ik.R', 'thigh_parent.R', 'foot_heel_ik.R', 'thigh_ik_target.R'}):
...
class RigLayers(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = col.row()
        row.prop(context.active_object.data, 'layers', index=25, toggle=True, text='Hair')
        row.prop(context.active_object.data, 'layers', index=26, toggle=True, text='Clothes')
